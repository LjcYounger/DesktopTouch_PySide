...
class GlobalConstants:
    ...
    MOUSE_HIT_AREA = (mouse.Button.left, mouse.Button.right, mouse.Button.middle)
...
class Ring3Constants:
    START_LIFETIME = lambda: random.uniform(0.6, 0.7)

    @staticmethod
    def get_start_lifetime():
        return random.uniform(0.6, 0.7)
class Ring4Constants:
    START_LIFETIME = lambda: random.uniform(0.2, 0.4)
